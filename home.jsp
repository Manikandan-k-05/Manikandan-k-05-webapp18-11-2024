...
<nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="navbar-nav ml-auto">
			<li class="nav-item">
				<form class="d-flex" action="search.jsp" method="get"> <!-- Action points to search.jsp -->
					<input class="form-control mr-2" type="search" placeholder="Search Materials" name="query" aria-label="Search" required="required">
			...
			<li class="nav-item"><a class="nav-link text-danger" href="viewCart.jsp">Cart</a></li>
			...
			<li class="nav-item dropdown">
				...
				<div class="dropdown-menu" aria-labelledby="navbarDropdown">
					<a class="dropdown-item" href="search.jsp?sort=price_asc">Price: Low to High</a>
					<a class="dropdown-item" href="search.jsp?sort=price_desc">Price: High to Low</a>
				</div>
			</li>
		</ul>
	</div>
	...
	<div id="carouselExampleControls" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="image/ab.jpeg"
					alt="First slide" width="100%" height="400px">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="image/carosel_1.jpg"
					alt="Second slide" width="100%" height="400px">
			</div>
			<div class="carousel-item">
